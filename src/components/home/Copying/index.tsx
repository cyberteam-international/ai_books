...
const Copying = ({}: Props) => {
	...
	return (
		<div id="copying" className={`${s.copying}`}>
			...
			<video poster={"/images/copying_voices_poster.jpg"} autoPlay={false} controls={true} controlsList="nodownload" className={s.copying__video} src="/video/copying_voices.mp4"></video>
